...
public class GlobalExceptionHandler {
    ...
    // Thrown by DaoAuthenticationProvider when UserDetailsServiceImpl marks the account
    // disabled — i.e. the user hasn't verified their registration OTP yet.
    ...
    public ResponseEntity<ErrorResponse> handleGenericException(Exception ex) {
        log.error("Unhandled exception reached GlobalExceptionHandler", ex);   // <-- add this
        ErrorResponse body = new ErrorResponse(
                HttpStatus.INTERNAL_SERVER_ERROR.value(), "Internal Server Error",
